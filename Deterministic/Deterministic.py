...
# Parameters
params1 = [3.25, 100, 22.0, 50.0, 20.0, 500.0, 650, 220.0, 0.56, 6.0, 2.5] + [10 * np.random.rand() for _ in range(12)]
...
# Extract parameters
A, a, B, b, G, g, Cvec, P, r, v0, e0 = params1[:11]
...
for j in range(len(t)):
    ...
    X[6] = X[6] + (Aa * (params['P'] + C2 * 2 * params['e0'] / (1 + np.exp(params['r'] * (params['v0'] - (C1 * X[0]))))) - 2 * params['a'] * X[6] - X[1] * a2) * dt
